---
title: リストコンポーネント（v3）
description: コアコンポーネントのリストコンポーネント (v3) を使用すると、静的リストと静的リストを簡単に作成できます。
...
コアコンポーネントのリストコンポーネント (v3) を使用すると、静的リストと静的リストを簡単に作成できます。

## 使用方法 {#usage}

リストコンポーネント (v3) は、例えば、子ページの動的リストや、任意に定義した項目の静的リストを作成するために使用できます。 [デザインダイアログ](#design-dialog)では、利用可能なリストの種類や書式設定のオプションをテンプレート作成者が定義できます。[編集ダイアログ](#edit-dialog)では、利用可能なリストタイプやリスト要素の書式設定方法の中から、コンテンツエディターが選択できます。

## バージョンと互換性 {#version-and-compatibility}

このドキュメントでは、2022 年 2 月にコアコンポーネントのリリース2.18.0で導入されたリストコンポーネント v3 について説明します。
...
|--- |--- |--- |---|
| [v4](/help/components/list.md) | - | 互換性あり | 互換性あり |
| v3 | - | 互換性あり | 互換性あり |
...
![リストコンポーネントの編集ダイアログ](/help/assets/v3/list-edit.png)
...
![子ページのオプション](/help/assets/v3/list-edit-child-pages.png)
...
![固定リストオプション](/help/assets/v3/list-edit-fixed.png)
...
![検索リストのオプション](/help/assets/v3/list-edit-search.png)
...
![タグリストのオプション](/help/assets/v3/list-edit-tags.png)
...
![並べ替えオプション](/help/assets/v3/list-edit-sort-options.png)
...
![リストコンポーネントの編集ダイアログの「スタイル」タブ](/help/assets/v3/list-edit-styles.png)
...
![リストコンポーネントのデザインダイアログリストの設定](/help/assets/v3/list-design-list-settings.png)
...
![リストコンポーネントのデザインダイアログの項目設定](/help/assets/v3/list-design-item-settings.png)
