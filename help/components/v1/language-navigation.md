...
このドキュメントでは、2018 年 1 月にコアコンポーネントのリリース 2.0.0 で導入された言語ナビゲーションコンポーネント v1 について説明します。

>[!CAUTION]
>
>このドキュメントでは、言語ナビゲーションコンポーネント v1 について説明します。
>
>言語ナビゲーションコンポーネントの現在のバージョンについて詳しくは、 [言語ナビゲーションコンポーネント](/help/components/language-navigation.md) 文書。
