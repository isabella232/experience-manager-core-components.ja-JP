...
このドキュメントでは、2019年9月にコアコンポーネントのリリース 2.6.0 で導入されたエクスペリエンスフラグメントコンポーネント v1 について説明します。

>[!CAUTION]
>
>このドキュメントでは、エクスペリエンスフラグメントコンポーネント v1 について説明します。
>
>エクスペリエンスフラグメントコンポーネントの現在のバージョンについて詳しくは、[エクスペリエンスフラグメントコンポーネント](/help/components/experience-fragment.md)のドキュメントを参照してください。
