...
![階層リンクコンポーネント編集ダイアログ](/help/assets/breadcrumb-edit.png)
...
* **シャドウを無効にする** — 階層内のページがリダイレクトの場合、リダイレクト先のページの名前がターゲットの代わりに表示されます。 詳細については、「ナビゲーションコンポーネントの [シャドウサイト構造のサポート](navigation.md#shadow-structure) 」を参照してください。
...
* **シャドウイングを無効にする** — 階層リンクコンポーネントがページに追加された場合に、「シャドウイングを無効にする **** 」オプションのデフォルト値を定義します。
