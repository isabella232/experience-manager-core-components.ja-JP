...
このドキュメントでは、ページコンポーネントの現在のバージョン（2022年2月にコアコンポーネントのリリース 2.18.0 で導入された v3）について説明します。
...
|---|---|---|---|
| v3 | - | 互換性あり | 互換性あり |
| [v2](v2/page.md) | 互換性あり | 互換性あり | 互換性あり |
...
* **代替言語のリンクをレンダリング** - 有効にすると、同じサイトにある代替言語バージョンのページへのリンクが、ページの先頭に追加されます。
