...
* 内 **リンク** 次のいずれかを入力
   * 完全修飾 URL
   * 既存のAEMコンテンツの相対 URL
      * 以下を使用して、 **選択ダイアログ** をクリックして、AEMから項目を選択します。
* 内 **テキスト** 「 」フィールドで、リスト内のリンクに表示するテキストを入力します。
* リンクを新しいブラウザータブで開く場合は、チェックボックスをオンにします

リストに複数の項目を作成したら、リストを整理できます。
...
![リストコンポーネントの編集ダイアログの「スタイル」タブ](/help/assets/list-edit-styles.png)
