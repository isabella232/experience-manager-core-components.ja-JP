...
コアコンポーネントの開発について詳しくは [、コアコンポーネント開発者向けドキュメント]（. mdの開発）を参照してください。

>[!NOTE]
>
>コアコンポーネントリリース2.1.0では、ナビゲーションコンポーネントは [schema.orgマイクロデータ](https://schema.org)をサポートしています。
...
ナビゲーションコンポーネントは、AEM [スタイルシステムをサポート](authoring.md#component-styling)しています。