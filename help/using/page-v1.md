...
ページコンポーネントは、 [テンプレートエディター](https://helpx.adobe.com/experience-manager/6-4/sites/authoring/using/templates.html) で機能するように設計された拡張可能なページコンポーネントであり、テンプレートエディターでページヘッダーやフッターと構造コンポーネントを組み立てることができます。
...
[デザインダイアログ](page-v1.md#main-pars_title_1995166862)を使用して、ページにカスタムのクライアントサイドライブラリを定義できます。コンポーネントがページであるため、編集ダイアログを直接アクセスできる他のコンポーネントとは異なり、コンポーネントはページのプロパティウィンドウに [](page-v1.md#main-pars_title) なります。

## バージョンと互換性 {#version-and-compatibility}

本書では、元々、コアコンポーネントのリリース1.0.0とAEM6.3で導入された、ページコンポーネントのv1について説明します。

次の表に、ページコンポーネントのv1との互換性を示します。

| AEM のバージョン | ページコンポーネントv1 |
|--- |--- |
| 6.3 | 互換性 |
| 6.4 | 互換性 |
...
>[!CAUTION]
>
>本書では、ページコンポーネントのv1について説明します。
>
>ページコンポーネントの現在のバージョンについて詳しくは [、ページコンポーネント](page.md) ドキュメントを参照してください。

>[!NOTE]
>
>ページコンポーネントのv1は、ページのリダイレクトをサポートしていません。ページのリダイレクト [サポートには、現在のバージョンのページコンポーネント](page.md) を使用してください。
...
コンポーネントはページ全体を表しているので、通常は編集ダイアログに表示される設定が [ページプロパティ](https://helpx.adobe.com/experience-manager/6-4/sites/authoring/using/editing-page-properties.html) ウィンドウに表示されます。

## デザインダイアログ {#design-dialog}

コンポーネントはページ全体を表しているので、ページ情報/ページデザインを使用 **してデザインダイアログにアクセス**します。

![](assets/chlimage_1-94.png)

ページデザインウィンドウを使用して、ページとともに読み込む必要のあるクライアント側ライブラリを定義できます。
...
クライアント側ライブラリの使用について詳しくは、クライアント側ライブラリ [の使用](https://helpx.adobe.com/experience-manager/6-3/sites/developing/using/clientlibs.html)を参照してください。

![](assets/chlimage_1-95.png)

## 技術的詳細 {#technical-details}

ページコンポーネントに関する最新の技術ドキュメントは、GitHubにあり [ます](https://github.com/adobe/aem-core-wcm-components/tree/master/content/src/content/jcr_root/apps/core/wcm/components/page/v1/page)。
