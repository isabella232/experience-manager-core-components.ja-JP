...
このオプションでは、「追加」ボタンをクリックしてアダプティブフォームコンポーネントを追加できます。このボタンは、編集モードでウィザードを追加したときにデフォルトで表示されます。
...
The **許可されたコンポーネント** 「 」タブを使用すると、テンプレートエディターで、アダプティブFormsエディターのウィザードコンポーネント内のパネルに、項目として追加できるコンポーネントを設定できます。

### 「スタイル」タブ {#styles-tab}

デザインダイアログは、コンポーネントの CSS スタイルを定義および管理するために使用します。 アダプティブFormsウィザードのコアコンポーネントは、AEMをサポートします。 [スタイルシステム](/help/get-started/authoring.md#component-styling).

![「スタイル」タブ](/help/adaptive-forms/assets/tabs-styles-tab.png)

- **デフォルトの CSS クラス**：アダプティブFormsウィザードのコアコンポーネントのデフォルト CSS クラスを指定できます。
