---
title: アダプティブFormsコアコンポーネント — 電子メール入力
description: アダプティブForms電子メール入力コアコンポーネントを使用するか、カスタマイズします。
...
# 電子メール入力 {#Email-input-adaptive-forms-core-component}

アダプティブフォームの電子メール入力コアコンポーネントは、ユーザーから電子メールアドレスを収集するために使用します。 E メール入力フィールドを使用すると、ブラウザーは、入力されたデータが有効な E メールアドレス形式であることを検証できます。 通常はテキストボックスとして表され、有効な電子メールアドレスのみを受け入れるパターン検証がおこなわれます。 電子メール入力フィールドは、「必須」、「プレースホルダー」、「パターン」などの追加の属性を使用してさらにカスタマイズし、入力データの検証を設定できます。

<!-- ## Sample Component Output {#sample-component-output}

To experience the Accordion Component as well as see examples of its configuration options as well as HTML and JSON output, visit the [Component Library](https://adobe.com/go/aem_cmp_library_accordion). -->

アダプティブフォームに電子メール入力コンポーネントを含める方がメリットが大きい理由は、次のようにいくつかあります。

* **ユーザーの利便性**:電子メール入力を使用すると、フィールドに予想されるデータを明確に示すので、ユーザーが電子メールアドレスを簡単に入力できます。

* **パーソナライズされた通信**:フォームを通じてユーザーから電子メールアドレスを収集すると、確認電子メールやニュースレターの送信など、パーソナライズされたコミュニケーションが可能になります。

* **リードジェネレーション**:フォームを通じて電子メールアドレスを収集すると、企業は電子メールリストを作成し、それをリードジェネレーションに使用できます。

* **ユーザー認証**:電子メールアドレスは、制限されたコンテンツやサービスにアクセスするための認証の手段として使用できます。

* **フィードバックの収集**:フィードバック形式で電子メールを入力すると、ビジネスは、フィードバックのフォローアップや明確化のためにユーザーとコミュニケーションを取ることができます。

## バージョンと互換性 {#version-and-compatibility}

アダプティブForms E メール入力コアコンポーネントは、コアコンポーネント 2.0.4 の一部として 2023 年 2 月にリリースされました。次の表に、サポートされているすべてのバージョン、AEMの互換性、対応するドキュメントへのリンクを示します。
...
アダプティブForms電子メール入力コアコンポーネントの最新情報については、 [GitHub](https://github.com/adobe/aem-core-forms-components/tree/master/ui.af.apps/src/main/content/jcr_root/apps/core/fd/components/form/emailinput/v1/emailinput). コアコンポーネントの開発について詳しくは、 [コアコンポーネント開発者向けドキュメント](/help/developing/overview.md).

## 設定ダイアログ {#configure-dialog}

設定ダイアログを使用すると、訪問者に対する電子メール入力エクスペリエンスを簡単にカスタマイズできます。 また、シームレスなユーザーエクスペリエンスを実現するために、簡単に電子メール入力オプションを定義できます。
...
* **最大文字数**  — このオプションを使用すると、フィールドで許可する最大文字数を指定できます。 指定した値より大きい文字を入力する場合は、 **最大文字数**&#x200B;と入力すると、エラーメッセージが画面に表示されます。 この **最大文字数のエラーメッセージ** ダイアログボックスで、カスタムエラーメッセージを追加できます。
...
<br>
    ...
    「**検証パターン**」オプションを使用すると、入力した電子メール ID を検証するパターンを入力できます。 「**パターン**」オプションに入力された値で電子メール ID を検証できない場合は、エラーメッセージが画面に表示されます。
    * **パターン** — このオプションを使用すると、E メールで許可する検証パターンを入力できます。 正規表現も使用できます。
    * **エラーメッセージ** — このオプションを使用すると、「**パターン**」オプションに入力した値で電子メール ID が検証されなかった場合に、画面に表示するメッセージを入力できます
...
デザインダイアログは、E メール入力コンポーネントの CSS スタイルを定義および管理するために使用されます。


### 「スタイル」タブ {#styles-tab}

デザインダイアログは、コンポーネントの CSS スタイルを定義および管理するために使用します。 アダプティブForms電子メール入力コアコンポーネントは、AEM [スタイルシステム](/help/get-started/authoring.md#component-styling).

**デフォルトの CSS クラス**:アダプティブForms電子メール入力コアコンポーネントのデフォルト CSS クラスを指定できます。
