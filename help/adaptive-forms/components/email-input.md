...
The **検証パターン** 「 」オプションを使用すると、入力した電子メール ID を検証するためのパターンを入力できます。 電子メール ID が **パターン** 」オプションを選択すると、エラーメッセージが画面に表示されます。

- **パターン**  — このオプションを使用すると、E メールで許可されている検証パターンを入力できます。 ここでは正規表現も使用できます。
- **エラーメッセージ**  — このオプションを使用すると、電子メール ID が、 **パターン** オプション
