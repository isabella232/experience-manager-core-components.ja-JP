...
| `includeFormscommunications` | `n` | 次を含む [Forms Core Components](https://github.com/adobe/aem-core-forms-components) 依存関係、テンプレート、フォームデータモデル、テーマ、およびForms Communications プログラムに対応するアーティファクトを生成します。 |
| `includeFormsenrollment` | `n` | 次を含む [Forms Core Components](https://github.com/adobe/aem-core-forms-components) 依存関係、テンプレート、フォームデータモデル、テーマ、およびForms登録プログラムに対応するアーティファクトを生成します。 |

## システム要件 {#requirements}

| アーキタイプ | AEM as a Cloud Service | AEM 6.5 | Java SE | Maven |
|---------|---------|---------|---------|---------|
| [32](https://github.com/adobe/aem-project-archetype/releases/tag/aem-project-archetype-32) | 継続的 | 6.5.7.0+ | 8、11 | 3.3.9 以上 |
