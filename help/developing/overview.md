...
## コアコンポーネントの成功方法 {#how-to-succeed}

コアコンポーネントは、強力で柔軟性が高く、使いやすく、カスタマイズも簡単です。 [いくつかの主要なガイドラインに従うことで](success.md) 、コアコンポーネントを含むプロジェクトを確実に成功させることができます。
