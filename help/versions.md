...
|---|---|---|---|---|---|---|
| [2.19.0](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.19.0) | このリリースでは、 [コンポーネントを検索](/help/components/quick-search.md) そして、 [ボタンコンポーネント](/help/components/button.md) さらに、多くのアクセシビリティの改善とバグの修正もおこないました。 | - | 6.5.10.0+ * | 継続的 | 8、11 | 2022年3月17日（PT） |
